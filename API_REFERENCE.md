...
Complete reference for all MCP tools available in Joplin MCP v2.0.0.
...
**v2.0.0 Update**: Note operations are now specialised into separate tools for clarity and precision.
...
- **Joplin MCP Version:** 1.8.4
- **MCP Protocol:** 2024-11-05
- **Joplin Desktop:** 2.13+ (Web Clipper API)
- **Python:** 3.9+
- **Operating System:** Linux and macOS (from v2.0.0)
